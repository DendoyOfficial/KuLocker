...
<body>
    ...
    function eksekusiUpdateStatus(id, statusBaru) {
        ...
        .then(response => {
            if (response.ok) {
                ...
                // Reload denah kotak atas saja secara dinamis
    ...
    // Modal Functions untuk User Data
    ...
    document.addEventListener('click', function(event) {
        const modalPemesanan = document.getElementById('modal-detail-pemesanan');
        const modalPembayaran = document.getElementById('modal-detail-pembayaran');
        const modalUser = document.getElementById('modal-detail-user');
        const modalHapusLocker = document.getElementById('modal-hapus-loker');
        ...
        if (event.target === modalHapusLocker) {
            modalHapusLocker.style.display = 'none';
        }
    });
    </script>
</body>
